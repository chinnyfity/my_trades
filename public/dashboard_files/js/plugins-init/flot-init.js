(function($) {
 ...
 var dzChartlist = function(){
	...
	var flotRealtime1 = function(){
		...
		var data = [], totalPoints = 150, totalPoints2 = 161, totalPoints3 = 105, totalPoints4 = 115;
		...
		function getRandomData2() {
			if (data.length > 100)
				data = data.slice(1);
			while (data.length < totalPoints3) {
				var prev = data.length > 100 ? data[data.length - 1] : 50,
					y = prev + Math.random() * 10 - 25;
				if (y < 100) {
					y = 100;
				} else if (y > 0) {
					y = 0;
		...
		var plot42 = $.plot('#flotRealtime11', [getRandomData2()], {
			colors: ['#c9970f'],
			series: {
				lines: {
					show: true,
		...
		var plot43 = $.plot('#flotRealtime12', [getRandomData1()], {
			colors: ['#c9970f'],
			series: {
				lines: {
					show: true,
		...
		var plot44 = $.plot('#flotRealtime13', [getRandomData()], {
			colors: ['#c9970f'],
			series: {
				lines: {
					show: true,
		...
		function update_plot4() {
			...
			plot4.draw();
			setTimeout(update_plot4, 2000);
		}
		function update_plot42() {
			plot42.setData([getRandomData()]);
			plot42.draw();
			setTimeout(update_plot42, 4500);
		}
		function update_plot43() {
			plot43.setData([getRandomData()]);
			plot43.draw();
			setTimeout(update_plot43, 6660);
		}
		function update_plot44() {
			plot44.setData([getRandomData()]);
			plot44.draw();
			setTimeout(update_plot44, 4188);
		}
	}
