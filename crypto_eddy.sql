...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2022 at 05:51 AM
...
INSERT INTO `admin_tbls` (`id`, `uname`, `pass1`, `last_login`) VALUES
...
INSERT INTO `other_settings` (`id`, `names`, `percents`) VALUES
(1, 'starter', 200),
(2, 'silver', 200),
(3, 'gold', 250),
(4, 'platinum', 400),
...
CREATE TABLE `settings` (
  `id` int(11) NOT NULL,
  `withdraw_charges` varchar(20) DEFAULT NULL,
  `currency_exchange` varchar(40) DEFAULT NULL,
  `active_traders` varchar(40) DEFAULT NULL,
  `customers` varchar(40) DEFAULT NULL,
  `countries_supported` varchar(40) DEFAULT NULL,
  `stop_earning` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `settings` (`id`, `withdraw_charges`, `currency_exchange`, `active_traders`, `customers`, `countries_supported`, `stop_earning`) VALUES
(1, '1.5', '4543', '5410', '11866', '57', 0);
...
CREATE TABLE `transactions` (
  ...
  `sender_addr` varchar(100) DEFAULT NULL,
  `receiver_addr` varchar(100) DEFAULT NULL,
  `amt_usd` varchar(50) DEFAULT NULL,
...
INSERT INTO `transactions` (`id`, `status`, `trans_type`, `coins`, `transId`, `expiry`, `user`, `sender_addr`, `receiver_addr`, `amt_usd`, `notes`, `date_created`) VALUES
(1, 'failed', 'deposit', 'ETH', NULL, 1645615560, 20, '0x646Ec0bc40d5C46CD648E26B61f1f1A73E8284Ae', 'bc1q7nl7ccjvk98uwjvephu0yye303e2u0g705kksk', '100', NULL, '2022-02-23 11:16 am'),
(77, 'approved', 'deposit', 'BTC', 'BEZSTOV62N', NULL, 20, 'tthghgjhnbgbhvfcdfrttthghgjhnbgbhvfcdfrtdf', 'bc1q7nl7ccjvk98uwjvephu0yye303e2u0g705kksk', '200', NULL, '2022-02-26 1:50 am'),
(78, 'pending', 'deposit', 'USDT', '6SA1Y39WVG', NULL, 20, 'tthghgjhnbgbhvfcdfrttthghgjhnbgbhvfcdfrtdf', 'bc1q7nl7ccjvk98uwjvephu0yye303e2u0g705kksk', '200', NULL, '2022-02-26 1:51 am'),
(97, 'pending', 'cronjob', 'BTC', '9999999', NULL, 999, NULL, NULL, NULL, NULL, '2022-02-27 3:07 am'),
(105, 'pending', 'cronjob', 'BTC', '9999999', NULL, 999, NULL, NULL, NULL, NULL, '2022-02-27 3:25 am'),
(106, 'pending', 'withdrawal', 'btc', 'QDZWRNG1XS', NULL, 20, NULL, NULL, '9.85', NULL, '2022-02-28 3:52 am');
...
CREATE TABLE `users` (
  ...
  `rawp` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `phone` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mft_acct` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kyc` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kyc_approved` int(2) DEFAULT NULL,
  `address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `countrys` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `states` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `citys` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_file` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `usd_btc` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `usd_btc_bal` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `usd_eth` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `usd_eth_bal` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `usd_usdt` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `usd_usdt_bal` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
INSERT INTO `users` (`id`, `approved`, `plan`, `fullname`, `email`, `email_verified_at`, `pass`, `rawp`, `phone`, `mft_acct`, `kyc`, `kyc_approved`, `address`, `countrys`, `states`, `citys`, `addr_file`, `usd_btc`, `usd_btc_bal`, `usd_eth`, `usd_eth_bal`, `usd_usdt`, `usd_usdt_bal`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 0, '', 'Chinny Anthony', 'donchibobo@gmail.com', NULL, '$2y$10$KbirdURtp10UvDGrnVwy2O4pUzX1glqmMwhkYw5gDDbvRgKxf5fbO', '', NULL, '', NULL, 0, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '0', '0', '0', 'XPGRJBOOKasxSUwAQ5OJMXgTJhFaE42cNnA3o5mRixEB4myBZHpZqdaVelwC', NULL, NULL),
(2, 0, '', 'Boris Goyette', 'barton.mozelle@goyette.com', NULL, '$2y$10$hcv4InJ8pyQEEEe/mXxIvOGJwPNPeKFxPKhTOXq8q6iS7iYsrC0/y', '', NULL, '', NULL, 0, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '0', '0', '0', NULL, NULL, NULL),
(3, 0, '', 'Cayla Kunze MD', 'ofelia.conroy@hotmail.com', NULL, '$2y$10$mtlZgSFB6aTI0L6BnkThReBiVhzdXQvgCJ1IZxp7SXcLCLwAhc3b6', '', NULL, '', NULL, 0, NULL, NULL, NULL, NULL, NULL, '0', '0', '0', '0', '0', '0', NULL, NULL, NULL),
(20, 1, 'silver', 'Amos Dauda', 'ghghg123@sss.sss', NULL, '$2y$10$2Ha3xmfI2HBbgyXzfvwuSOaRCq0ZlIbmNinYUIM./OQoHh1T29ii2', '', '388484884', '210173', '164553845514.jpg', 1, 'shdhsjjs', '160', '2651', 'sjdhhdd', '164554078439.png', '200', '140.8', '200', '200', '10', '8', 'tL7emQUPvGVX6RmTbN492WCjzZd6uO72nIIOH8QX7vry6BOvVWGmoSEWobZJ', '2022-02-21 02:58:15', '2022-02-28 02:52:29');
